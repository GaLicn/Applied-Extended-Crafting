...
import com.gali.applied_extended_crafting.block.CrafterCorePatternProviderBlock;
...
public final class ModBlocks {
    ...
    public static final DeferredBlock<CrafterCorePatternProviderBlock> CRAFTER_CORE_PATTERN_PROVIDER = BLOCKS.register(
            "crafter_core_pattern_provider",
            CrafterCorePatternProviderBlock::new
    );

    public static final DeferredBlock<FluxCrafterPatternProviderBlock> FLUX_CRAFTER_PATTERN_PROVIDER = BLOCKS.register(
