...
public class FluxCrafterPatternProviderLockReason implements ICompositeWidget {
    protected boolean visible = false;
    protected int x;
    protected int y;

    private final FluxCrafterPatternProviderScreen screen;

    public FluxCrafterPatternProviderLockReason(FluxCrafterPatternProviderScreen screen) {
        this.screen = screen;
    }
