...
public class CrafterCorePatternProviderLockReason implements ICompositeWidget {
    protected boolean visible = false;
    protected int x;
    protected int y;

    private final CrafterCorePatternProviderScreen screen;

    public CrafterCorePatternProviderLockReason(CrafterCorePatternProviderScreen screen) {
        this.screen = screen;
    }
