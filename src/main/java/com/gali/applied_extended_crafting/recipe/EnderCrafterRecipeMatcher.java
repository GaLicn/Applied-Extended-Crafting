...
public class EnderCrafterRecipeMatcher implements IRecipeMatcher<IEnderCrafterRecipe> {
    private RecipeManager cachedRecipeManager;
    private List<RecipeHolder<IEnderCrafterRecipe>> cachedRecipes = List.of();
    ...
    private List<RecipeHolder<IEnderCrafterRecipe>> getRecipes(Level level) {
    ...
    private boolean matchesOutput(Map<AEKey, Long> patternOutputs, IEnderCrafterRecipe recipe, Level level) {
